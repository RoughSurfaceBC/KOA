...
function uploadFile( ctx, options) {
  ...
  console.log('同步创建文件目录', mkdirResult);
  ...
  return new Promise((resolve, reject) => {
    ...
    busboy.on('file', function(fieldname, file, filename, encoding, mimetype) {
      ...
      console.log(_uploadFilePath, saveTo)
      ...
      file.on('end', function() {
        ...
        if (getSuffixName(filename) === 'jpg' || getSuffixName(filename) === 'png') {
          result.data = {
...
function uploadFileAsync(ctx, options) {
